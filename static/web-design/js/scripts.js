...
$(document).ready(function() {
    ...
    if ($('.slider-paging-controls').length) {
        $('.slider-paging-controls').flexslider({
            animation: "slide",
            directionNav: false
        });
    };
    if ($('.slider-arrow-controls').length) {
        $('.slider-arrow-controls').flexslider({
            controlNav: false
        });
    };
    if ($('.slider-thumb-controls .slides li').length) {
    ...
    if ($('.slider-thumb-controls').length) {
